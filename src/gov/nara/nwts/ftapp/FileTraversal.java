...
public class FileTraversal {
	...
	public void reportCancel() {
		System.err.println("중지: " +max + "개의 항목이 발견됨.");
	}//Stopping items found
	...
	public void reportDuration(double duration) {
		System.out.println(numProcessed+"개의 항목들.  "+ FTDriver.ndurf.format(duration) + " 초 소요됨");
		System.out.flush();//items	seconds
	}
