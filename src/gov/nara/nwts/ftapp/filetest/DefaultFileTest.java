...
public abstract class DefaultFileTest implements FileTest {
    ...
    public void showCount(int count) {
   		if (count>0) System.out.println("진행률 계산: "+count+" 개의 파일들이 처리됨.");
    ...
    public void cleanup(int count) {
    	if (count>0) System.out.println("진행률 계산: "+count+" 개의 파일들이 처리됨. 정리 시작.");
    	//Progress Count: "+count+" files processed. Start Cleanup.
    	System.gc();
		System.runFinalization();
		if (count>0) System.out.println("정리 완료.");//Cleanup complete
		System.out.flush();
    }
