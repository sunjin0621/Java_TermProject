...
class RandomFileTest extends DefaultFileTest implements Randomizer {
	...
	public static Object[][] details = {
		...
		{YN.class,"선택된",60, YN.values(),false},//Selected
	};
    ...
    public String getShortName(){return "무작위 샘플링";}//Random
	...
	public String getDescription() {
		return "QC 프로세싱을 위해 임의 순서대로 파일 목록을 반환합니다.";//This test will return a list of files in random order for QC processing
	}
